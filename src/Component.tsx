    ...
    async function setup(
      ...
      if (client.loginFailure) {
        ...
        vm = new RoomViewModel({
          ...
          features,
          imageSizeConfig: {
            maxWidth: maxImageWidth || 1200,
            maxHeight: maxImageHeight || 800,
          },
        });
        await vm.load();
        ...
        vm.composerViewModel.on(
          ...
          (event?: 'canSend' | 'replyViewModel' | 'focus') => {
            const tiles = [...vm.timelineViewModel.tiles];
  ...
  return (
    ...
    >
      ...
      >
        ...
        {!agentPresence.isActive && <p className="status">Agent is offline</p>}
      </div>
    </div>
  );
}
